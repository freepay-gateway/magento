...
class FreePayCom extends AbstractHelper
{
     ...
     * @return mixed
     */
    public function convertCountryAlphas3To2($code = 'DNK') {
     ...
     * @return mixed
     */
    public function convertCountryAlphas3ToNumber($code = 'DNK') {
     ...
     * @return mixed
     */
    public function convertCountryAlphas2To3($code = 'DK') {
     ...
     * @return mixed
     */
    public function convertCountryAlphas2ToNumber($code = 'DK') {
